...
<section id="login">
    <div id="window-login" class="col-sm-12">
        ...
        <div id="opciones-login" class="col-sm-6">
            ...
            <p class="text-center font-weight-bold mb-3 " style="color: white; font-size: 20px">Cliente</p>
            <div id="sec-1-login-prove" class="flex-column">
                <form>
                    ...
                    <input type="submit" id="login-aceptar" onclick="location.href='../core/televisores.php'" value="Log In"></input>
                </form>
            </div>
